const data = [
  {
    id: 1,
    title: 'Overmax X-Monster Truck',
    price: 40,
    description: 'X-MONSTER: to zdalnie sterowany samochód RC wykonany w skali 1:18 dedykowany dla dzieci w wieku 14 +. Zapewni świetną zabawę oraz dostarczy frajdy dla całej rodziny',
    images: [
      '/productImages/product1-1.jpg',
      '/productImages/product1-2.jpg',
      '/productImages/product1-3.jpg'
    ]
  },
  {
    id: 2,
    title: 'Szybki samochód RC Offroad Buggy',
    price: 60,
